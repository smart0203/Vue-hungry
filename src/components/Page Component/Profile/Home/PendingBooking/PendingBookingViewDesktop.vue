<template>
  <div class="border rounded-lg shadow max-width pending-booking">
    <div class="flex pb-2">
      <div class="relative flex items-center">
        ...
        <div class="absolute left-0" style="bottom: -12px">
          <div class="text-xl">
            <div
    ...
    <div class="flex items-end justify-end flex-grow mr-3">
      <button
