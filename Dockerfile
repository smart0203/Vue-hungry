...
COPY deployment/conf/web.conf /etc/nginx/conf.d/default.conf
COPY deployment/conf/modules.conf /etc/nginx/modules-enabled

COPY cached-artifacts/dist /usr/share/nginx/html